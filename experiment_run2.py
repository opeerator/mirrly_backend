...
if __name__ == "__main__":
    ...
    audio_m1 = AudioSegment.from_file('experiment/voice_s2/1.m4a')
    audio_m2 = AudioSegment.from_file('experiment/voice_s2/2.m4a')
    audio_m3 = AudioSegment.from_file('experiment/voice_s2/3.m4a')
    audio_m4 = AudioSegment.from_file('experiment/voice_s2/4.m4a')
    audio_m4_jazz = AudioSegment.from_file('experiment/voice_s2/4-jazz.m4a')
    audio_m5 = AudioSegment.from_file('experiment/voice_s2/5.m4a')
    audio_m6 = AudioSegment.from_file('experiment/voice_s2/6.m4a')
    audio_m7 = AudioSegment.from_file('experiment/voice_s2/7.m4a')
    audio_m8 = AudioSegment.from_file('experiment/voice_s2/8.m4a')
    audio_m9 = AudioSegment.from_file('experiment/voice_s2/9.m4a')
    ...
    try:
        ...
        sound_waiter(len(audio_m1) - 2500)
        
        playaudio(audio_m2)
        sound_waiter(len(audio_m2))
        ...
        jazz1 = subprocess.Popen(['vlc', '--intf', 'dummy', '--loop', '/home/mirrly/mirrly_backend/experiment/voice_s2/4-jazz.m4a'], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        ...
        playaudio(audio_m7)
        sound_waiter(len(audio_m7))
        
        playaudio(audio_m8)
        sound_waiter(len(audio_m8))
